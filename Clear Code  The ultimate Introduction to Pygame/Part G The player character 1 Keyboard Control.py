...
while True:
    ...
    # keys=pygame.key.get_pressed()                        1st method of keyboard control 
   ...
   # if player_rect.colliderect(snail_rect):    #if player rect with snail collide print  
    ...
    # When using classes you want to control inside of the relevant class.
    #pygame.mouse and pygame.keys are great for that 

    # ideally classes are self contain including input methods and hence not within the game loop 
   
    # But most of the time it should be in the even loop as it is easy to work with 
