...
while run:
    ...
    #game logic                     You can either use 'get pressed' or event handler for game logic depending on the situation         
    key=pygame.key.get_pressed()     # get_pressed is best for Continous Movement whilst event Handler for single actions. 
